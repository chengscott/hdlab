...
HD_PWD='/media/scott/BC74E09A74E058A2/hdlab/lab3_1/lab3_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab3_1.vdi -applog -m64 -messageDb vivado.pb -mode batch -source lab3_1.tcl -notrace
